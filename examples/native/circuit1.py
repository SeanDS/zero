...
# add components
circuit.add_component(Capacitor(name="c1", value=10e-6, node1="gnd", node2="n1"))
circuit.add_component(Resistor(name="r1", value=430, node1="n1", node2="nm"))
circuit.add_component(Resistor(name="r2", value=43e3, node1="nm", node2="nout"))
circuit.add_component(Capacitor(name="c2", value=47e-12, node1="nm", node2="nout"))
circuit.add_component(OpAmp(name="o1", model="LT1124", node1="nin", node2="nm", node3="nout"))
